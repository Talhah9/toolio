export const TOOLS = [
  ...
  },
  {
    ...
    intro_fr: 'Crée un devis professionnel avec lignes de service, TVA et conditions de paiement en quelques secondes. Dès le 1er septembre 2026, la facturation électronique devient obligatoire — pensez à choisir une Plateforme Agréée comme Indy.',
    intro_en: 'Build a professional quote with service lines, VAT, and payment terms in seconds.',
    features_fr: ['Devis professionnel avec toutes vos prestations', 'Calcul automatique des totaux et de la TVA', 'Conditions de paiement personnalisées', 'Téléchargeable en PDF prêt à envoyer', 'Facturation électronique obligatoire dès sept. 2026 — restez conformes avec Indy'],
